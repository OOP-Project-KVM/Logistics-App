...
class Location:
    ...
    def __str__(self):
        # arrival_str = self._arrival_time.strftime(Location.DATE_FORMAT) if self._arrival_time else 'No arrival
        # expected' departure_str = self._departure_time.strftime(Location.DATE_FORMAT) if self._departure_time else
